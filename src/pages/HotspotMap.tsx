...
import { Droplets, Thermometer, Waves, Navigation, MapPin, AlertTriangle, CloudLightning, Tornado } from "lucide-react";
            ...
            {mockWeatherHazards.map((hazard) => (
              ...
              >
                <div
                  ...
                  title={`${hazard.type === 'storm' ? 'Storm Warning' : hazard.type === 'tornado' ? 'Tornado Warning' : 'High Waves'} - ${hazard.severity.toUpperCase()} severity`}
                >
                  {hazard.type === 'storm' ? (
                    ...
                    <div className={`rounded-full p-2 ${hazard.severity === 'high' ? 'bg-purple-700' :
                      hazard.severity === 'medium' ? 'bg-purple-500' :
                        'bg-purple-300'
                      }`}>
                      <Tornado className="h-6 w-6 text-white" />
                    </div>
                  ) : (
                ...
                <div className="p-2 min-w-[200px]">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <p className="font-bold text-sm text-foreground">
                      {selectedHazard.type === 'storm' ? 'Storm Warning' : selectedHazard.type === 'tornado' ? 'Tornado Warning' : 'High Waves'}
                    </p>
                  </div>
