        ...
        <div className="relative z-10 px-8 py-16 md:py-24 flex flex-col items-center text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/hotspot-map">
              <Button
                size="lg"
                className="h-12 px-8 font-semibold rounded-lg bg-white/10 text-white backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/20 transition-colors flex items-center justify-center"
              >
            ...
            <Link to="/dashboard">
              <Button
                size="lg"
                className="h-12 px-8 font-semibold rounded-lg bg-white/10 text-white backdrop-blur-md border border-white/20 shadow-lg hover:bg-white/20 transition-colors"
              >
                View Dashboard
              </Button>
            </Link>
